...
public class CatalogoItem extends TableRow {
	...
	public CatalogoItem(Context context) {
		super(context);
		((Activity)context).getLayoutInflater().inflate(R.layout.catalogo_item, this);
		init();
	}

	public CatalogoItem(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
