...
public class PhotoTextGridListItem3 extends TableRow {
	...
	public PhotoTextGridListItem3(Context context) {
		super(context);
		((Activity)context).getLayoutInflater().inflate(R.layout.photo_text_grid_list_item2, this);
		init();
	}

	public PhotoTextGridListItem3(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
